...
- **Project Structure:** Implemented a markdown-based workflow for projects, where each project (e.g., _Astro Dungeon_, _BioTopia_) exists as a standalone `.md` file with dedicated metadata.
